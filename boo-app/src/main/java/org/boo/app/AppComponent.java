...
@Service
public class AppComponent  implements EventHistoryService {
   ...
   //pruneEventHistoryTask() execution interval in seconds
    ...
    protected void activate() {
        appId = coreService.registerApplication("org.boo.app");
        log.info("Bivas - Registered as {}", appId);

        pruner = newSingleThreadScheduledExecutor(minPriority(groupedThreads("onos/boo-app", "history-pruner")));
        ...
        log.info("Bivas - activate() Started");
    }
    ...
    protected void deactivate() {
        ...
        pruner.shutdownNow();
        history.clear();
        log.info("Bivas -deactivate() Stopped");
    }
    ...
    class InternalDeviceListener  implements DeviceListener {
        ...
        public void event(DeviceEvent event) {
            addEvent(event);
           log.info("Bivas -IDL event is :" + event.toString());
        }
    }
    ...
    class InternalLinkListener implements LinkListener {
        ...
        public void event(LinkEvent event) {
            addEvent(event);
            log.info("Bivas -ILL event is :" + event.toString());
        }
    }
